...
async function seedMasterData() {
  ...
  try {
    ...
    console.log('✅ 58 jenis kegiatan ditambahkan');
    ...
    console.log('✅ 56 approver ditambahkan');
    ...
    console.log('✅ 48 lokasi ditambahkan');
    ...
    console.log('✅ 40 jenis konsumsi ditambahkan');
